...
export default function App() {
  ...
  // Theme colors based on mode
  const accentColor = isComradeMode ? "text-yellow-500" : "text-indigo-400";
  const glowColor = isComradeMode ? "bg-red-600/20" : "bg-indigo-500/20";
  const borderColor = isComradeMode ? "border-yellow-500/30" : "border-indigo-500/20";
  const glowRGB = isComradeMode ? "220, 38, 38" : "99, 102, 241"; // Red-600 vs Indigo-500
  ...
  return (
    ...
    >
      ...
      {!isMobile && (
        <>
          <motion.div
            className={`fixed top-0 left-0 w-8 h-8 border-2 ${isComradeMode ? 'border-yellow-500' : 'border-indigo-500'} rounded-full pointer-events-none z-[100] mix-blend-difference`}
            style={{
              x: cursorX,
              y: cursorY,
              translateX: "-50%",
          ...
          >
            <div className={`absolute inset-0 ${isComradeMode ? 'bg-red-500/20' : 'bg-indigo-500/20'} rounded-full blur-sm`}></div>
          </motion.div>
          <motion.div
        ...
        >
          ...
          <motion.div variants={itemVariants} className="h-full">
            ...
            >
              ...
              {/* Social links + CV download in one row */}
              <div className="mt-8 flex gap-3 flex-wrap items-center">
                ...
                {!isComradeMode && (
                  <a
                    ...
                    className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-indigo-600/20 hover:bg-indigo-600/40 border border-indigo-500/30 hover:border-indigo-500/60 text-indigo-300 hover:text-white text-sm font-semibold transition-all duration-300 group"
                  >
          ...
          <div className="flex flex-col gap-4 md:gap-6">
                ...
                >
                  <div className="flex flex-col h-full">
                    <div className="flex items-center gap-3 mb-6">
                      <MessageSquare className={isComradeMode ? "text-yellow-400" : "text-indigo-400"} />
            ...
            <motion.div variants={itemVariants}>
              <GlowingCard
                ...
                glowRGB={glowRGB}
              >
                <GameSlideshow isComradeMode={isComradeMode} />
              </GlowingCard>
            </motion.div>
          </div>
        </motion.div>
        ...
        >
          ...
          <motion.div variants={itemVariants}>
            <GlowingCard
              ...
              glowRGB={glowRGB}
            >
              <RepoList repos={repos} isComradeMode={isComradeMode} />
            </GlowingCard>
          </motion.div>
          ...
          <motion.div variants={itemVariants}>
            <GlowingCard
              ...
              glowRGB={glowRGB}
            >
              <ContactForm isComradeMode={isComradeMode} />
            </GlowingCard>
          </motion.div>
        </motion.div>
      </div>
